...
bool Conductor::CreatePeerConnection(bool dtls) {
    ...
    qDebug() << "<++++ 15.5";
    qDebug() << QString::fromUtf8(server.uri.c_str());
    config.servers.push_back(server);
...
void Conductor::onJsonMsgSlot(QString msg) {
//    qDebug() << "<=========================>";
//    qDebug() << msg;
//    QJsonDocument doc = QJsonDocument::fromJson(msg.toUtf8());
//    QJsonObject jsonObj = doc.object();
//    this->OnMessageFromPeer(12, jsonObj["body"].toString().toStdString());
}
...
//    //    qDebug() << "Error" << "Failed to connect to " << server_;
//}
